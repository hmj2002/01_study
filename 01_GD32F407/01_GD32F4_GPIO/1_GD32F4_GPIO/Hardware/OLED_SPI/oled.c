...
void OLED_ShowNum(u8 x,u8 y,float num1,u8 len)
{
	...
	OLED_Display_GB2312_string(x-24,y,(u8*)".");//显示小数点
	for(i=0;i<len;i++)
	{
		t=num%10;//取个位数的数值
		num=num/10;//将整数右移一位
		...
		switch(t)
		{
			case 0 :OLED_Display_GB2312_string(x,y,(u8 *)"0");break;
			case 1 :OLED_Display_GB2312_string(x,y,(u8 *)"1");break;
			case 2 :OLED_Display_GB2312_string(x,y,(u8 *)"2");break;
			case 3 :OLED_Display_GB2312_string(x,y,(u8 *)"3");break;
			case 4 :OLED_Display_GB2312_string(x,y,(u8 *)"4");break;
			case 5 :OLED_Display_GB2312_string(x,y,(u8 *)"5");break;
			case 6 :OLED_Display_GB2312_string(x,y,(u8 *)"6");break;
			case 7 :OLED_Display_GB2312_string(x,y,(u8 *)"7");break;
			case 8 :OLED_Display_GB2312_string(x,y,(u8 *)"8");break;
			case 9 :OLED_Display_GB2312_string(x,y,(u8 *)"9");break;
		}
	}
}
...
{//PA2  3  5  7 推挽
	...
	GPIO_output(DC_RCU,DC_PORT,DC_PIN,GPIO_OTYPE_PP,1);
  GPIO_output(CS1_RCU,CS1_PORT,CS1_PIN,GPIO_OTYPE_PP,1);
	//PC5  推挽
	GPIO_output(CS2_RCU,CS2_PORT,CS2_PIN,GPIO_OTYPE_PP,1);
